                ...
                <div class="col-12">
                    <div class="section-title text-center mb-4 pb-2">
                        ...
                        <p class="text-muted para-desc mx-auto mb-0">
                            Explore our robust set of features designed to streamline your expense management workflow.   
                        </p>
                        <p class="text-muted para-desc mx-auto mb-0">From real-time tracking to comprehensive reporting, we provide the tools you need to take control of your finances.</p>
                        <p class="text-muted para-desc mx-auto mb-0">Create an account to get started and unlock the full potential of seamless expense management today!  </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div class="card service-wrapper rounded border-0 shadow p-4">
                        ...
                        <div class="content mt-4">
                            ...
                            <p class="text-muted mt-3 mb-0">It is a long established fact that a reader will be distracted by the when looking at its layout.It is a long established fact that a reader will be distracted by the when looking at its layout.It is a long established fact that a reader will be distracted by the when looking at its layout.</p>
